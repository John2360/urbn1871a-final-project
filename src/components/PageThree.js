    ...
    <div className='page-wrapper' id='page3' style={{height: 'auto', minHeight: '110vh', alignItems: 'flex-start'}}>
        <div className='container'>
            ...
            <Accordian title={"Policy 2: The Capital Center Project Development Plan"} text={<div className='accordian-split'>
                <div style={{width: '55%', padding: 5}}>
                    <p>The Capital Center Project Development Plan was developed in 1979. The planners embellished on their idea of moving the rail lines by outlining a plan to move the train station. The planners also intended to deindustrialize the area by selling off railroad property to developers. The planners also suggested a series of road and rail bridges over the river. “Many of these roads were quite wide and crossed at acute angles, creating oddly shaped city blocks and unnecessary connections to nowhere.” Ryan,49.” One centerpiece of the Capital Center Development District was the Providence Place Mall which opened in 1999. The mall was “to revitalize the urban center of the city, create new jobs, and generate tax revenue.”</p>
                </div>
                <div style={{width: '45%'}}>
            ...
            <Accordian title={"Policy 3: The Providence Waterfront Study"} text={<div className='accordian-split'>
                <div style={{width: '55%', padding: 5}}>
                    <p>Developed in 1985, the Waterfront Study’s goal was to revitalize the waterfront around the Woonasquatucket, Moshassuck, and Providence rivers. The plan was to rearrange roads to travel parallel to the river and reduce bridges and structures over the bridge. The planners recreated the original Providence Great Salt Cove by building a small cove in the Woonasquatucket River. They also decided to add parkland along the river and under the I-95.</p>
                </div>
                <div style={{width: '45%'}}>
